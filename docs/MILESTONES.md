...
|---|-----------|-------------|------|
| **M0** | **Visual mockup** *(current)* | Clickable dark-mode mockup of the Case Board + Inspection/Damage Map in the locked aesthetic (artifact page, no code project) | Founder approves or vetoes the look |
