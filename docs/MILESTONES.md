...
| **M1** | **Scaffold & foundation** ⏳ *built 2026-08-20 — in founder review: [PR #1](https://github.com/tradergunny/AutomotiveOA/pull/1) · brief: [milestones/M1-scaffold-foundation.md](milestones/M1-scaffold-foundation.md)* | Next.js + TS + Tailwind + shadcn repo; dark theme tokens; TH/EN i18n plumbing; auth (Advisor/Manager); tenant-guarded data layer (ADR-001); Shop/Staff/User schema; seeded pilot Shop | Login works; shell renders in both languages |
