...
| **M2** | **Customers, Vehicles & Check-in** ⏳ *brief drafted 2026-08-20 — in founder review: [milestones/M2-customers-vehicles-checkin.md](milestones/M2-customers-vehicles-checkin.md)* | Phone-lookup customer create/find; Vehicle by plate (body type); check-in flow opening a Repair Case with walkaround photos | A real check-in can be performed end-to-end |
