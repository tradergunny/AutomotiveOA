...
| **M2** | **Customers, Vehicles & Check-in** ⏳ *built 2026-08-25 — in founder review: [PR #2](https://github.com/tradergunny/AutomotiveOA/pull/2) · brief: [milestones/M2-customers-vehicles-checkin.md](milestones/M2-customers-vehicles-checkin.md)* | Phone-lookup customer create/find; Vehicle by plate (body type); check-in flow opening a Repair Case with walkaround photos | A real check-in can be performed end-to-end |
