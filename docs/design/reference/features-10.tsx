/**
 * REFERENCE ARTIFACT — not wired into any build.
 * Pasted by the founder (2026-08-19) as the styling reference for the whole app,
 * from the same family as their prior "UFC project". See ../DESIGN.md for the
 * extracted rules (dark-first, rounded-none, corner-tick decorator, dashed
 * borders, hatch fills, shadcn structure, lucide-react icons).
 * Depends on standard shadcn/ui card + cn(); integrate only at scaffold time.
 */
